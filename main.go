...
// The original package was "github.com/tyler-smith/go-bip39" but it has been deleted
package bip39
...
import (
	...
	"github.com/hamidteimouri/gobip39/wordlists"
...
func MnemonicToByteArray(mnemonic string, raw ...bool) ([]byte, error) {
	...
	// Calculate the uncheck-summed entropy so we can validate that the checksum is
	// correct.
